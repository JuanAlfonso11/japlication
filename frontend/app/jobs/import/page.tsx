...
function ImportContent() {
  ...
  return (
    <div className="space-y-6 pb-4 animate-fade-in">
      ...
      {/* The app already takes a job shared from another app (see the share
          intent in MainActivity), and this screen never mentioned it: the
          fastest way in was the one nobody knew about. */}
      {!wasShared && (
        <div className="flex items-start gap-3 rounded-2xl bg-brand-50 p-4 dark:bg-brand-900/20">
          ...
          <p className="text-xs leading-relaxed text-brand-900 dark:text-brand-200">
            <span className="font-bold">Más rápido:</span> en LinkedIn, Chrome o donde veas la vacante,
            toca Compartir y elige JobPilot. Llega aquí con la URL puesta.
          </p>
        </div>
      )}
